...
const Button = ({
  ...
  const variantStyles = {
    primary:
      "bg-gradient-to-r from-sky-400 to-blue-500 text-white shadow-lg shadow-blue-400/25 hover:from-sky-500 hover:to-blue-600 hover:shadow-xl hover:shadow-blue-400/30",
