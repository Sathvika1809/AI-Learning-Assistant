...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <>
      {/* Mobile overlay */}
      <div
        className={`fixed inset-0 bg-slate-900/20 backdrop-blur-[2px] z-40 md:hidden transition-opacity duration-300 ${
          ...
          {navLinks.map((link) => (
            <NavLink
              ...
              className={({ isActive }) =>
                ...
                ${
                  isActive
                    ? "bg-gradient-to-r from-sky-400 to-blue-500 text-white shadow-lg shadow-blue-400/20"
