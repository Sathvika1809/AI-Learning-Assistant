  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back of the card */}
        <div
          className="absolute inset-0 w-full h-full bg-gradient-to-br from-sky-400 to-blue-500 border-2 border-sky-300/60 rounded-2xl shadow-xl shadow-blue-400/25 flex flex-col justify-between"
          style={{
            backfaceVisibility: "hidden",
            WebkitBackfaceVisibility: "hidden",
